...
void Setup5110Triger(uintptr_t GraphicsMemory, uint16_t GraphicsMemorySize)
{
  DMACTL0 = 0;
  DMACTL0 |= DMA0TSEL__USCIA0TX;
  DMACTL4 = DMARMWDIS; // Read-modify-write disable
  DMA0CTL = DMADT_5 + DMASRCINCR_3 + DMADSTBYTE + DMASRCBYTE + DMAEN;
  __data20_write_long((uintptr_t)&DMA0SA, (uintptr_t)P3PortData);
  __data20_write_long((uintptr_t)&DMA0DA, (uintptr_t)&P3OUT);
  DMA0SZ = 2;
  DMACTL0 |= DMA1TSEL__DMA0IFG;
  DMA1CTL = DMADT_4 + DMASRCINCR_3 + DMADSTBYTE + DMASRCBYTE + DMAEN;
  __data20_write_long((uintptr_t)&DMA1SA, (uintptr_t)GraphicsMemory);
  __data20_write_long((uintptr_t)&DMA1DA, (uintptr_t)&UCA0TXBUF);
  DMA1SZ = GraphicsMemorySize;
}
void SetupSPWMTrigger(uintptr_t Buffer,uint16_t BufferSize){// use dma2
    DMACTL1 |= DMA2TSEL__TA2CCR0;
    DMACTL4 = DMARMWDIS;
    DMA2CTL = DMADT_4 + DMASRCINCR_3 + DMAEN;
    __data20_write_long((uintptr_t)&DMA2SA,Buffer);
    __data20_write_long((uintptr_t)&DMA2DA,(uintptr_t)&TA2CCR1);
    DMA2SZ = BufferSize;
}
#if 0
